...
User-installed skills may still live under `./.codex/skills` for project scope, or `~/.codex/skills` for user-installed skills. Setup-owned prompt files and native-agent TOML defaults are intentionally omitted in plugin mode unless explicitly installed.
