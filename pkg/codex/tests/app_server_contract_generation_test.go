...
const contractGenerationPinnedSchema = "https://raw.githubusercontent.com/openai/codex/refs/tags/rust-v0.134.0-alpha.3/codex-rs/app-server-protocol/schema/json/codex_app_server_protocol.v2.schemas.json"
