...
func TestArtifactWorkflowPortGenerationHasSingleGoGenerateEntrypoint(t *testing.T) {
	...
	for _, want := range []string{
		...
		"https://raw.githubusercontent.com/openai/codex/refs/tags/rust-v0.134.0/codex-rs/app-server-protocol/schema/json/codex_app_server_protocol.v2.schemas.json",
		"-out ./protocol_gen.go",
		"-package codex",
	} {
