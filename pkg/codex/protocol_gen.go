// Code generated by go generate ./pkg/codex; DO NOT EDIT.
// Source: codex app-server generate-json-schema --experimental
// Source binary: codex-cli 0.137.0-alpha.4
...
func (value *ConfigRequirements) UnmarshalJSONFrom(dec *jsontext.Decoder) error {
	...
	value.AllowedPermissions = raw.AllowedPermissions
...
func (value *ThreadStartParams) UnmarshalJSONFrom(dec *jsontext.Decoder) error {
	...
	value.Cwd = raw.Cwd
	value.DeveloperInstructions = raw.DeveloperInstructions
	value.DynamicTools = raw.DynamicTools
...
type TurnStartParams struct {
	...
	// Environments optional turn-scoped environments.
	//
	...
	// ResponsesapiClientMetadata optional turn-scoped Responses API client metadata.
	ResponsesapiClientMetadata map[string]string `json:"responsesapiClientMetadata,omitzero"`

	// RuntimeWorkspaceRoots replaces the thread's runtime workspace roots for this turn and subsequent turns. Relative paths are resolved against the effective cwd for the turn.
	RuntimeWorkspaceRoots []string `json:"runtimeWorkspaceRoots,omitzero"`
