...
const remoteImageURL = "https://raw.githubusercontent.com/github/explore/main/topics/python/python.png"
...
func main() {
	...
	result, err := thread.Run(ctx, []codex.InputItem{
		codex.TextInput{Text: "What is in this image? Give 3 bullets."},
		codex.ImageInput{URL: remoteImageURL},
	}, nil)
	if err != nil {
		log.Fatal(err)
	}
