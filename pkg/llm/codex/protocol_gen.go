...
// Source binary: codex-cli 0.143.0-alpha.6
...
type ThreadForkResponse struct {
	...
	// MultiAgentMode current multi-agent mode for this thread.
...
type ThreadStartParams struct {
	...
	// MultiAgentMode sets the initial multi-agent mode for this thread. `none` leaves the multi-agent tools available without injecting mode instructions. Omitted defaults to `explicitRequestOnly`.
	MultiAgentMode MultiAgentMode `json:"multiAgentMode,omitzero"`
...
type TurnStartParams struct {
	...
	// MultiAgentMode controls multi-agent v2 delegation instructions. `none` leaves the multi-agent tools available without injecting mode instructions. Omitted keeps the loaded session's current mode.
	MultiAgentMode MultiAgentMode `json:"multiAgentMode,omitzero"`
