...
// Source binary: codex-cli 0.146.0-alpha.4
...
type ExternalAgentConfigImportParams struct {
	...
	// ProviderID opaque provider identifier supplied by the caller for analytics attribution. This does not select the migration source.
...
type ThreadPayload struct {
	...
	// IsPinned reports whether the thread has been pinned by the user.
	IsPinned bool `json:"isPinned,omitzero"`
...
type ThreadListParams struct {
	...
	// IsPinned optional pinned filter; when set, only threads matching this value are returned.
	IsPinned bool `json:"isPinned,omitzero"`
...
type ThreadMetadataUpdateParams struct {
	...
	// IsPinned patch whether this thread is pinned. Omit to leave the stored value unchanged.
	IsPinned bool   `json:"isPinned,omitzero"`
	ThreadID string `json:"threadId"`
}
