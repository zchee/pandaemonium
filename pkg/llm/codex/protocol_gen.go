...
// Source binary: codex-cli 0.142.0-alpha.7
...
type AmazonBedrockAccount struct {
	CredentialSource AmazonBedrockCredentialSource `json:"credentialSource,omitzero"`
	Type             string                        `json:"type"`
}
...
// AmazonBedrockCredentialSource is generated from the AmazonBedrockCredentialSource schema definition.
type AmazonBedrockCredentialSource string

const (
	// AmazonBedrockCredentialSourceCodexManaged is the "codexManaged" AmazonBedrockCredentialSource value.
	AmazonBedrockCredentialSourceCodexManaged AmazonBedrockCredentialSource = "codexManaged"
	// AmazonBedrockCredentialSourceAwsManaged is the "awsManaged" AmazonBedrockCredentialSource value.
...
const (
	...
	// AskForApprovalValueOnFailure is the "on-failure" AskForApprovalValue value.
...
const (
	...
	// RequestMethodThreadTurnsItemsList is the "thread/turns/items/list" ClientRequest method.
	RequestMethodThreadTurnsItemsList = "thread/turns/items/list"
...
// ThreadTurnsItemsListRequest is generated from the Thread/turns/items/listRequest schema definition.
type ThreadTurnsItemsListRequest struct {
	ID     string                     `json:"id"`
	Method string                     `json:"method"`
	Params ThreadTurnsItemsListParams `json:"params"`
}

func (ThreadTurnsItemsListRequest) isClientRequest() {}
...
func decodeGeneratedClientRequest(raw jsontext.Value) (ClientRequest, error) {
	...
	if err := json.Unmarshal(raw, &object); err == nil {
		...
		case RequestMethodThreadTurnsList:
			...
			return value, nil
		case RequestMethodThreadTurnsItemsList:
			var value ThreadTurnsItemsListRequest
			if err := json.Unmarshal(raw, &value); err != nil {
				return nil, err
			}
			return value, nil
...
// MultiAgentMode controls whether the model should only spawn sub-agents after an explicit user request or may delegate proactively when doing so would help.
type MultiAgentMode string

const (
	// MultiAgentModeExplicitRequestOnly is the "explicitRequestOnly" MultiAgentMode value.
	MultiAgentModeExplicitRequestOnly MultiAgentMode = "explicitRequestOnly"
	// MultiAgentModeProactive is the "proactive" MultiAgentMode value.
...
type MessageResponseItem struct {
	...
	Metadata ResponseItemMetadata `json:"metadata,omitzero"`
...
// ResponseItemMetadata is generated from the ResponseItemMetadata schema definition.
...
type ThreadForkResponse struct {
	...
	// MultiAgentMode current selected multi-agent mode for this thread, if one was selected.
...
func (value *ThreadForkResponse) UnmarshalJSONFrom(dec *jsontext.Decoder) error {
	...
	value.Model = raw.Model
	value.ModelProvider = raw.ModelProvider
	value.MultiAgentMode = raw.MultiAgentMode
...
// SleepThreadItem is generated from the SleepThreadItem schema definition.
...
type ThreadListParams struct {
	...
	// ParentThreadID optional direct parent thread filter.
	ParentThreadID string `json:"parentThreadId,omitzero"`
...
type ThreadRealtimeStartParams struct {
	...
	// CodexResponseHandoffPrefix optional prefix added to automatic V1 Codex commentary sent with `conversation.handoff.append` when `codexResponsesAsItems` is not true. Final answers are sent without the prefix.
	CodexResponseHandoffPrefix string `json:"codexResponseHandoffPrefix,omitzero"`
...
func (value *ThreadRealtimeStartParams) UnmarshalJSONFrom(dec *jsontext.Decoder) error {
	...
	value.CodexResponseHandoffPrefix = raw.CodexResponseHandoffPrefix
...
type ThreadSettingsUpdateParams struct {
	...
	// MultiAgentMode selects the multi-agent mode for subsequent turns.
	MultiAgentMode MultiAgentMode `json:"multiAgentMode,omitzero"`
...
type ThreadStartParams struct {
	...
	// MultiAgentMode sets the initial multi-agent mode for this thread. Omitted leaves the thread without a selected mode. Eligible multi-agent v2 turns still default to `explicitRequestOnly`.
	MultiAgentMode MultiAgentMode `json:"multiAgentMode,omitzero"`
...
func (value *ThreadTurnsItemsListResponse) UnmarshalJSONFrom(dec *jsontext.Decoder) error {
	...
	value.BackwardsCursor = raw.BackwardsCursor
	if raw.Data == nil {
		value.Data = nil
	} else {
		value.Data = make([]ThreadItem, len(raw.Data))
		for i, item := range raw.Data {
			if item != nil {
				decodedData, err := decodeGeneratedThreadItem(item)
				if err != nil {
					return err
				}
				value.Data[i] = decodedData
			}
		}
	}
	value.NextCursor = raw.NextCursor
	return nil
}
...
type TurnStartParams struct {
	...
	// MultiAgentMode controls whether multi-agent v2 delegation requires an explicit user request. Omitted keeps the loaded session's current mode.
	MultiAgentMode MultiAgentMode `json:"multiAgentMode,omitzero"`
